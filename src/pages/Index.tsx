  ...
  return (
    <div className="min-h-screen bg-dark-100 text-white relative overflow-hidden">
      ...
      <section className="container mx-auto px-6 md:py-48 max-w-6xl py-[92px]">
        <h2 className="text-3xl md:text-4xl terminal-text text-white text-center mb-6">
          Why the Old Way Hurts
        </h2>
        <p className="text-xl text-gold/80 text-center mb-20 max-w-3xl mx-auto terminal-text">
          Cold lists waste time. Ad platforms hide targeting. Competitors hammer the same stale data.
          Feel the cost: hours burnt, CAC climbing, deals drifting.
        </p>
        ...
        <div className="space-y-6 text-center">
          <p className="text-xl md:text-2xl terminal-text gold-glow max-w-4xl mx-auto">
            Feel any of that in your gut? Picture freeing that time for closing, not guessing.
          </p>
          <p className="text-xl terminal-text text-gold/60">
            Scroll—relief is seconds away.
          </p>
        </div>
      </section>
    </div>
